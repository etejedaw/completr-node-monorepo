...
3. **Granular**: cada commit cubre un único cambio lógico. Si el working tree mezcla cambios no relacionados, se dividen en commits separados.
...
3. Por cada grupo:
    - Stagear solo los archivos del grupo con `git add <files>` (o `git add -p` para hunks específicos).
